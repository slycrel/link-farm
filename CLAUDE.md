...
- Top topics: agent-design (463), dev-practices (330), research (202), claude-code (184), skills-mcp (181), management (122), prompting (121), industry (113), questionable (112), general (103). The two newest taxonomy entries are barely populated — `adjacent` (1) and `solo-operator` (1) — so material they were added for is likely still landing in `general`/`industry`; worth a targeted re-tag pass.

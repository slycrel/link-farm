...
- [Ole Lehmann](https://x.com/itsolelehmann/status/2055290989577753034) — 2026-05-15: Nine workflows to build first to make Hermes a real Chief of Staff: daily brief, self-improving viral swipe file, trending-workflows radar, meeting-prep briefing, a 'Humanizer' that strips AI writing tells, bookmark inbox (X bookmarks -> tagged Obsidian notes), customer-support cron, weekly business report, and an Obsidian LLM-wiki second brain.

- [0xMarioNawfal](https://x.com/roundtablespace/status/2055268207221682640) — 2026-05-15: SocratiCode gives an AI deep semantic understanding of a codebase (dependency graphs, symbol-level impact analysis, cross-project search, zero config): 61% less context, 84% fewer tool calls, 37x faster than grep-based exploration, tested on 40M lines, fully local.

- [Arpit Bhayani](https://x.com/arpit_bhayani/status/2055265636390207784) — 2026-05-15: Deep dive on what production-grade RAG actually requires beyond demos: chunking (where most systems fail), embedding-model lock-in, reindexing, document registries and chunk identity, index updates, and tracing/observability. RAG usually fails on indexing/retrieval/observability, not the model.

- [Khairallah AL-Awady](https://x.com/eng_khairallah1/status/2055215784092401966) — 2026-05-15: A full course on building multi-agent teams, framed around Anthropic's May 2026 multi-agent orchestration for Claude Managed Agents (up to 20 parallel agents; Netflix/Harvey/Shopify). Three patterns (pipeline, fan-out, specialist team), standardized output formats, Dreaming for cross-session memory (~6x completion gains at Harvey), rubric-based Outcomes, and incremental testing. Notes Cowork was built on this architecture.

- [CyrilXBT](https://x.com/cyrilxbt/status/2055183411619549265) — 2026-05-15: GitHub's official 'Agentic AI Developer' certification (GH-600) - the first formal credential for operating, supervising, and integrating AI agents across the SDLC, framed as recognizing agent-team work as an engineering discipline.

- [Meenakshi Yadav](https://x.com/meenakshiyacs/status/2055104295641710718) — 2026-05-15: A cheat sheet for designing/explaining Agentic AI architecture: goal, orchestration layer, agents layer, tools layer, memory (short + long-term), monitoring, reliability & failure (retries/fallbacks/human-in-the-loop), and governance & security. 'Agents alone don't make systems powerful; architecture does.'
...
- [Avid](https://x.com/av1dlive/status/2054948286403150017) — 2026-05-15: Two Airbnb senior staff engineers gave a live lecture on agentic coding (Airbnb shipped a major production LLM-agent migration); links a 'How to Build AI Agents in 2026' course arguing most builders ship demos, not production agents.

- [Berryxia.AI](https://x.com/berryxia/status/2054924976835510337) — 2026-05-15: Tencent AI open-sourced an agent-memory system after 6 months on context loss in long sessions: real-time compression of stale context (61% fewer tokens), a mermaid-based structured task map (fewer lost trajectories in 30+ step flows), and dedicated Persona memory (consistency 48->76%).
...
- [Rohit Ghumare](https://x.com/ghumare64/status/2054625511897489423) — 2026-05-14: On why agent architecture matters: codebases that survive past month six do so because the architecture makes the bad shape unexpressible (not team discipline). Four canonical month-six failures and the Worker/Function/Trigger 'React-of-2013' fix; cites the Claude Code April 2026 postmortem (runtime changes cut median thinking length 73%, pushed retries up 80x).

- [divyansh tiwari](https://x.com/divyansht91162/status/2054430633645293687) — 2026-05-14: NanoResearch: an architecture for agents that continuously evolve around the user via three co-evolving layers - Skill Bank (repeated actions -> reusable expertise), Memory Layer (project/user experience across sessions), and Policy Learning (free-form feedback -> permanent behavioral updates).
...
- [Geek Lite](https://x.com/qingq77/status/2054056472477307084) — 2026-05-14: Oh My Hermes - an opinionated workflow layer that installs an 'operating system' on Hermes: 20 skills across the full app lifecycle and 5 agents (CTO/PM/Dev/QA/Ops) collaborating on a kanban board, with Claude Code/Codex as optional deep-coding accelerators.

- [Ihtesham Ali](https://x.com/ihtesham2005/status/2054458335215395223) — 2026-05-13: A Google+Meta paper where Claude Code proposes, tests, and refines its own reasoning algorithms with no human in the loop after setup - in 5 rounds discovering a controller with four coordinated mechanisms 'difficult to arrive at through manual intuition alone,' for a total discovery cost of $39.90.

- [GREG ISENBERG](https://x.com/gregisenberg/status/2054261832718889216) — 2026-05-13: A free 47-min course on building a managed AI-agent business solo: sell a 'digital employee' (unlimited agents/usage, infra+security included), don't niche down too fast, solve universal exec pain first, and use a Hermes + Codex/Claude Code + Orgo + Composio + Agent Mail + Obsidian stack (GPT-5.5 default, GLM 5.1 for cheap tasks).

- [Joseph Viviano](https://x.com/josephdviviano/status/2054253118943363506) — 2026-05-13: 'Agentic Research Best Practices' - using coding agents for research (vs engineering): research code must be reproducible, understandable, correct, and fully understood, not production-grade. Workflow of paper.tex/design_doc.md -> roadmap -> task plans, short AGENT.md, separate planning/implementation/verification agents, notes.md, commit-per-TODO (git as savegames), worktrees, and constraining diffs. Reports 2-10x iteration speedups.
...
- [Garry Tan](https://x.com/garrytan/status/2053538847795880414) — 2026-05-11: 'Code as memory' (via @finbarr): work with the agent non-deterministically the first time (research + write a script), then just execute the script on every future run. Links 'How to really stop your agents from making the same mistakes.'

- [Garry Tan](https://x.com/garrytan/status/2053127519872614419) — 2026-05-10: 'Meta-Meta-Prompting' - personal AI as an operating system: a 100k-page 'brain,' a book-mirror pipeline, and a Skillify meta-skill that turns repeated workflows into composable, tested skills. Thin harness (OpenClaw), fat skills (100+), fat data, interchangeable models. Open-sourced as GStack/GBrain; thesis that the future belongs to individuals who build compounding AI systems.
...
- [Ole Lehmann](https://x.com/itsolelehmann/status/2050548948419645488) — 2026-05-02: The 'premortem' as a Claude skill: instead of asking 'is this a good plan?' (which triggers optimism), tell Claude 'it's 6 months from now and this is already dead - tell me how it died.' Kahneman's favorite decision technique. Returns each failure mode with a story + early warning signs, then synthesizes most-likely/most-dangerous failures, the biggest hidden assumption, and a revised plan.

- [Blaze](https://x.com/browomo/status/2050509770604331510) — 2026-05-02: A French teenager built a voice+gesture-controlled 3D map of his knowledge via Claude + Google Antigravity - no VR/controllers. Stack: Three.js, MediaPipe Hands, local Whisper, Claude API, assembled in a weekend. 217 mental models, 1,284 connections, 80ms gesture-to-redraw, ~1.4s voice-to-graph, zero mouse clicks. A clean prototype of a future PKM system.

- [Muhammad Ayan](https://x.com/socialwithaayan/status/2050484688968724820) — 2026-05-02: Repo share: warpdotdev/warp - 'an agentic development environment, born out of the terminal.'

- [Om Patel](https://x.com/om_patel5/status/2050441119003971683) — 2026-05-02: Engagement-y claim that /graphify makes Claude 71.5x more token-efficient at understanding a codebase - maps every function/dependency upfront, extracts structure locally, transcribes media via Whisper, uses Claude + subagents for docs/images, tags relationships EXTRACTED/INFERRED/AMBIGUOUS, exports HTML/JSON. Handles 25 languages, PDFs, SQL, docx/xlsx; post-commit hooks rebuild the graph. 40k stars.
...
- [regent0x](https://x.com/regent0x_/status/2050143341656838449) — 2026-05-02: Story of a solo contractor making $320k/yr with 5 parallel specialist Claude Code agents (architect/coder/reviewer/tester/ops) that don't share context and coordinate via a shared task queue - taking team-sized projects solo, ~13x return on API spend. 'Don't compete with teams; become the team.'

- [GPT Maestro](https://x.com/gptmaestro/status/2050060105052561681) — 2026-05-02: Points to 'Exploring GEPA' - how GEPA optimizes prompts/programs before inference (rather than cramming more context), addressing the same limitation RLMs target.

- [Mike Bespalov](https://x.com/bbssppllvv/status/2049924037111841027) — 2026-05-02: 'Agents make ugly UIs because they've never seen good design.' Released 2,000 DESIGN.md files from the world's best products, structured for a model to read - colors, type, spacing, layouts. Free at styles.refero.design.
...
- [Akshay](https://x.com/akshay_pachaar/status/2050201509821063576) — 2026-05-01: 'How to write Skills that never fail.' Skills use progressive disclosure (metadata always loaded, body on trigger, resources on demand) so the description does 90% of the work. Six practices: pushy directive descriptions (100% vs 37% activation), explicit exclusion clauses, keep SKILL.md under 200 lines, pair every generation skill with a verifier, iterate on the right layer (description vs body vs scripts), and build a regression fixture per skill. 'Maturation is removing something, not adding it.'

- [Teknium](https://x.com/teknium/status/2050098631907434871) — 2026-05-01: New Hermes feature (inspired by ralph loops and Codex's /goal): /goal <prompt> runs a loop with a supervisor model checking whether the task completed at the end of each agent loop, forcing it to continue until done. PR linked.

- [Garry Tan](https://x.com/garrytan/status/2049720409965392052) — 2026-04-30: Garry Tan shipping GBrain quality-of-life PRs needed to make it work on a brain pushing 74k markdown files.

- [How To AI](https://x.com/howtoai_/status/2049567036003795269) — 2026-04-30: 'Tencent killed fine-tuning and RL with an $18 budget' via Training-Free GRPO: instead of updating weights (expensive, causes base-model amnesia), extract the 'semantic advantage' of why one answer beat another, compress it into a 'token prior,' and attach it in the API call. On DeepSeek-V3, a few dozen samples produced a specialized expert outperforming fine-tuned models - zero parameter updates. Hype framing but a real technique.

- [Akshay](https://x.com/akshay_pachaar/status/2049476617144287719) — 2026-04-30: Rebuilt most of OpenClaw's core as a single open-source Sim workflow ('SimClaw') - 25 blocks, 29 connections, short + long-term memory, multi-channel (Telegram + Slack), self-hostable with local models, built from a single prompt. Framed as 'an OS for your AI workforce.'
...
- [Shubham Saboo](https://x.com/saboo_shubham_/status/2046473615118672325) — 2026-04-21: Repo share: codejunkie99/agentic-stack - 'One brain, many harnesses. Portable .agent/ folder (memory + ...)' - a portable agent memory/config folder usable across harnesses.

- [Tech with Mak](https://x.com/technmak/status/2046414820241760620) — 2026-04-21: 'Meta solved RAG's biggest bottleneck' - REFRAG compresses context chunks into single embeddings (process ~1,024 chunk embeddings instead of 16,384 tokens), exploiting sparse attention in RAG contexts via cached embeddings + an RL-based compression policy. Claims 30.85x faster time-to-first-token, zero perplexity loss, 16x context extension, no architecture changes.
...
- [Sydney Runkle](https://x.com/sydneyrunkle/status/2046277232537256002) — 2026-04-21: 'The runtime behind production deep agents' - harness (prompts/tools/skills) vs runtime (durable execution, memory, multi-tenancy, observability). Walks LangSmith Deployment / Agent Server: checkpointed durable execution, short- vs long-term memory, auth/RBAC/Agent Auth, human-in-the-loop (interrupt/resume), streaming + double-texting strategies, middleware guardrails, tracing + online evals (+13.7 pts on Terminal Bench 2.0 from harness changes alone), time travel, sandboxed code execution, MCP/A2A/webhooks, and cron. Packaged by 'deepagents deploy' as an open, MIT-licensed harness.

- [Nav Toor](https://x.com/heynavtoor/status/2046276160930414976) — 2026-04-21: 'PoisonedRAG': researchers showed 5 documents planted in a 2.6M-document database can hijack an LLM's answer 97% of the time - the attacker never touches the model or retriever, just writes a document. A retrieval-layer trust vulnerability.

- [Simplifying AI](https://x.com/simplifyinai/status/2046271932035645599) — 2026-04-21: 'Microsoft solved the context window problem' - paper MEMENTO teaches models to forget: reason in blocks, write a dense summary ('memento') after each, then physically delete the previous block from the KV cache and carry only the memento forward. Claims 6x context compression, 2.5x less KV-cache memory, zero accuracy loss - enabling local multi-step agents.
...
- [0xSero](https://x.com/0xsero/status/2044879665001595263) — 2026-04-17: 0xSero 'went 180' on multi-agents/subagents after analyzing hundreds of AI coding sessions - it helps a lot. Links 'Single-agent AI coding is a nightmare for engineers' on the pain of one slow single agent.
...
- [Garry Tan](https://x.com/garrytan/status/2044479509874020852) — 2026-04-15: 'Resolvers: The Routing Table for Intelligence' - a resolver maps task/content types to which document/skill to load. Confession: a 20,000-line CLAUDE.md degraded the model; a ~200-line decision tree replaced it and improved everything. A misfiling revealed only 3 of 13 skills consulted the resolver; fix = shared filing rules + mandate. 'Invisible skill' problem (skills that exist but aren't reachable) -> trigger evals + a check-resolvable meta-skill (found 6 unreachable skills). Resolvers decay ('context rot'); endgame is an RLM rewriting them from traffic. Resolvers are fractal and are the governance/management layer of an agent 'organization.' Open-sourced in GBrain/GStack.
...
- [Yoonho Lee](https://x.com/yoonholeee/status/2044442372864700510) — 2026-04-15: Released code for Meta-Harness (stanford-iris-lab/meta-harness) - a method for optimizing LLM harnesses end-to-end (long-horizon credit assignment over prior code/traces/scores). Point your agent at ONBOARDING.md to implement good Meta-Harnesses in new domains.

- [Shann³](https://x.com/shannholmberg/status/2044413638388363272) — 2026-04-15: Connected an Obsidian knowledge base (230+ cross-referenced pages) to every project so every agent reads the wiki first: indexed with qmd (hybrid BM25 + vector + LLM re-ranking, local) and a global /knowledge-shann skill any agent can call to load voice rules, frameworks, and metrics before working. Same pattern for company/client KBs. All markdown, one CLI command, works with any bash-capable agent.
...
- [Akshay](https://x.com/akshay_pachaar/status/2043745099792953508) — 2026-04-14: 'Build Agents that never forget' - a first-principles walk through agent memory. LLMs are stateless; 7 failure modes without memory; bigger context isn't the fix ('lost in the middle'). Cognitive-science frame (sensory/working/long-term; episodic/semantic/procedural; consolidation). Layers from Python list -> markdown files -> vector search (each fixing then revealing a limit, e.g. vectors miss multi-hop 'bridge' facts). Solution: Cognee, open-source engine combining relational + vector + graph stores in four calls (add/cognify/memify/search), deduped knowledge graph with dual indexing, RL-inspired memify, 14 retrieval modes.

- [Alex Finn](https://x.com/alexfinn/status/2043719233213980922) — 2026-04-14: 'Read a tweet, give it to your agent, and it upgrades.' Copy-paste SOUL.md prompt (from Garry Tan): 'The marginal cost of completeness is near zero with AI. Do the whole thing, do it right, with tests and docs... never present a workaround when the real fix exists. Search before building, test before shipping, ship the complete thing.'
...
- [Garry Tan](https://x.com/garrytan/status/2043581361798500602) — 2026-04-13: 'New item in my SOUL.md tonight' (shared as an image) - the widely-quoted SOUL.md addition on the 'marginal cost of completeness is near zero with AI: do the whole thing, do it right, ship the complete thing, not a plan.'

- [Charly Wargnier](https://x.com/datachaz/status/2043246635996807300) — 2026-04-13: Addy Osmani (Google) dropped Agent Skills: 19 engineering skills + 7 commands encoding senior-engineer quality gates across the lifecycle (Define/Plan/Build/Verify/Review/Ship) with slash commands (/spec /plan /build /test /review /code-simplify /ship). Bakes in Shift Left, Chesterton's Fence, Hyrum's Law; works with Claude Code/Cursor/Antigravity. npx skills add addyosmani/agent-skills.
...
- [Nav Toor](https://x.com/heynavtoor/status/2043321909971202403) — 2026-04-12: LLM Wiki v2 extends Karpathy's LLM Wiki with the features it lacked: confidence scoring (facts decay), memory tiers (working/episodic/semantic/procedural), a typed knowledge graph, hybrid search (BM25 + vector + graph, RRF-fused), automated hooks (auto-ingest/compress/decay), forgetting curves, and contradiction resolution by source recency/authority. Turns a flat wiki into a living memory that strengthens, weakens, consolidates, and forgets.
...
- [Nick Spisak](https://x.com/nickspisak_/status/2043060265823146202) — 2026-04-12: Claude Code shipped /ultraplan: sends planning to four Opus 4.6 cloud agents (three explorers + one critic) instead of one terminal agent. Covers why the review workflow matters more than the 4x speed, 5 scenarios where it prevents rework, and when to use local plan mode instead.

- [Garry Tan](https://x.com/garrytan/status/2042919242283258072) — 2026-04-12: New OpenClaw/Hermes users struggle with integrations, and you can't reach 1,000+ markdown files without proper mail/calendar integrations - GBrain now ships guided integration recipes on first install.

- [Veeral Patel](https://x.com/vral/status/2042674854764130549) — 2026-04-10: 'We'll look back on passing .md files between agents like mailing floppy disks.' Links Ramp Labs 'Latent Briefing: Efficient Memory Sharing for Multi-Agent Systems via KV Cache Compaction' - sharing compacted KV cache instead of text between agents to fix multi-agent token inefficiency.

- [Alpha Batcher](https://x.com/alphabatcher/status/2042606770816704643) — 2026-04-10: Architectural principles for a production AI agent: async generator (streaming-native) not a while loop, read-only tools parallel / write tools serial, tools execute during generation, cache-efficient system prompt, hierarchical compaction, every error has an in-loop recovery path, each sub-agent gets an isolated worktree + context. 'Infrastructure is the fourth layer - without it you have a demo not a product.' Links Rohit's 'harness from Claude Code leaks' article.

- [Akshay](https://x.com/akshay_pachaar/status/2042586319390674994) — 2026-04-10: What every big company thinks about the agent harness. Agreement: the model isn't the product, the infra around it is; disagreement: how thick. Anthropic bets thin ('dumb loop'); OpenAI Agents SDK code-first, slightly thicker; CrewAI adds a deterministic backbone; LangGraph bets on explicit graph control. Scaffolding metaphor - build infra designed to be removed as models improve, but remove carefully since models are trained WITH specific harnesses. Future-proofing test: a stronger model should improve performance without added harness complexity. LangChain changed only infra and jumped to rank 5 on TerminalBench 2.0. Links 'The Anatomy of an Agent Harness.'

- [Vaishnavi](https://x.com/_vmlops/status/2042486942802321552) — 2026-04-10: Google's MCP Toolbox - open-source MCP server giving agents plain-English access to 20+ databases (Postgres, MySQL, MongoDB, BigQuery, Redis, Elasticsearch, Spanner, Snowflake) with built-in pooling, auth, and OpenTelemetry; works with LangChain/LlamaIndex/Genkit/any MCP client; <10 lines to plug in.
...
- [Teknium](https://x.com/teknium/status/2042396576245825543) — 2026-04-10: Hermes added notify-when-done so a spawned background process queues a message back to the agent when finished (work on other things instead of polling). Quotes Claude's new Monitor tool doing the same. 'Open source can move faster than any closed company.'

- [ProxySoul](https://x.com/bniwael/status/2042364421373121018) — 2026-04-10: SoulForge: '1.8x faster, 2.1x cheaper, same model' by building a live importance-ranked graph of your codebase; real LSP via embedded Neovim (go-to-def, references, call hierarchy, type info), surgical reads, multi-edits, multi-tab cross-tab coordination via a real-time bus, per-tab/per-agent model routing. 30+ languages, 20+ providers, $0 compaction. Proof: same Opus 4.6 bug fix 6m22s vs 11m18s, $1.70 vs $3.52.
...
- [Seb Goddijn](https://x.com/sebgoddijn/status/2042286523001737545) — 2026-04-10: 'We hit 99% AI adoption at Ramp but it wasn't enough' - most people stuck in a chat window while power users ran laps. Built Glass, an AI productivity suite on Anthropic's Claude Agent SDK, 700 DAUs in a month. 'We don't lower the ceiling, we raise the floor.' Links 'We Built Every Employee at Ramp Their Own AI Coworker - The Models are Good Enough, The Harness Isn't.'
...
- [Avid](https://x.com/av1dlive/status/2042172428127002906) — 2026-04-10: A 16-min talk by two Anthropic engineers who built Claude Skills on how to build them right. Links Khairallah's 'How to Build Claude Skills That Actually Work' (80,000+ registry skills, most terrible - fire on wrong requests, inconsistent output, break on edge cases).

- [carsonfarmer](https://x.com/carsonfarmer/status/2042038527639068763) — 2026-04-09: 'So many AI-agent innovations are just Letta/MemGPT rediscovered.' Quotes Sarah Wooders: the new Anthropic managed-agents API is basically the year-old Letta API but closed-source with provider lock-in (even read-only memory blocks and memory-block sharing, long unique to Letta).

- [Aakash Gupta](https://x.com/aakashgupta/status/2041984945380585785) — 2026-04-09: Companies spending $200K/yr on AI seats with zero gains all make the same mistake: same foundation model, zero shared context. A 'Team OS' turns a GitHub repo into the team's collective brain for Claude (call summaries, specs, constraints, strategy docs). Compound effect: a team of 10 adding 2-3 artifacts/week => 250+ structured docs a quarter; a new hire gets a veteran's context in week one. DoorDash's Hannah Stulberg's team writes every doc in Claude Code, checks it in for review.

- [Ashpreet Bedi](https://x.com/ashpreetbedi/status/2041966288541507861) — 2026-04-09: Praises Viv's auto-improving-systems approach ('give it to Claude Code and let it rip'). Links Viv's 'Better Harness: A Recipe for Harness Hill-Climbing with Evals' - build better agents by building better harnesses, using evals as the learning signal.

- [mr-r0b0t](https://x.com/mr_r0b0t/status/2041930298238087464) — 2026-04-09: 'Harness evolution + specialist local models will be the way forward.' Links Viv's 'Better Harness: A Recipe for Harness Hill-Climbing with Evals' (LangChain team).

- [Justin Brooke](https://x.com/imjustinbrooke/status/2041890745167061245) — 2026-04-09: If you don't know what SOUL.md, AGENTS.md, USER.md, TOOLS.md, MEMORY.md, HEARTBEAT.md, STYLE.md are and how to use them, learn. Quotes @agentskills_ai: 'these 7 text files will run your business in 2027; harnesses > models' (diesel-engine-without-wheels analogy).

- [Vaishnavi](https://x.com/_vmlops/status/2041869776927261024) — 2026-04-09: Microsoft MarkItDown - converts anything (PDF, Word, Excel, PowerPoint, audio, YouTube URLs) into clean structured markdown for LLMs; one pip install, no custom parsers. github.com/microsoft/markitdown.

- [Sowmay Jain](https://x.com/sowmay_jain/status/2041982135305957425) — 2026-04-08: Had his AI agent process his whole-genome sequence end to end: found a 2-year-old email + link, pulled 67GB raw DNA, rented a $5 machine, aligned 21M reads (99.83% mapped), called 5.8M variants via a two-pass neural net, phased maternal/paternal, annotated against ClinVar/PharmGKB/gnomAD, and produced a health-risk map (39 conditions), drug guide (141 meds), nutrient metabolism, and ancestry - $5, 8 hours, one instruction. Quotes 1B+ rows of psychiatric-genetics GWAS data on HuggingFace.
...
- [Eric Siu](https://x.com/ericosiu/status/2040785346120859946) — 2026-04-06: 'Every org needs a world intelligence to operate at 10x.' Links 'How to practically deploy Jack Dorsey's world intelligence today' - Dorsey published an AI-native-company blueprint; author has run a version for 4 months powering 50+ daily workflows, coordinating decisions, surfacing issues.
...
- [Ejaaz](https://x.com/cryptopunk7213/status/2040434869399138368) — 2026-04-05: On AutoAgent, a self-improving AI: agents suck because of the harness (tools/system prompts), not the model; a Meta agent tweaks the harness, runs tests, and improves until #1 at its goal - works for any task, using the same model to evaluate (Claude managing Claude). Links Kevin Gu's 'AutoAgent: first open source library for self-optimizing agents' (#1 SpreadsheetBench 96.5%, #1 GPT-5 TerminalBench).

- [Charly Wargnier](https://x.com/datachaz/status/2039963758790156555) — 2026-04-03: Breaks down Karpathy's self-improving second brain: instead of complex RAG, the LLM pulls raw research into an Obsidian markdown wiki and takes over index creation, linting, and Q&A routing. Dump sources -> LLM auto-compiles an indexed .md wiki -> ask questions -> it generates outputs (Marp slides, matplotlib) and files them back. Implication: agents maintaining their own memory layer need clean file organization + queryable indexes, not huge context. Quotes Karpathy's original 'LLM Knowledge Bases' post.

- [Dmitriy Kovalenko](https://x.com/neogoose_btw/status/2039508756988620801) — 2026-04-02: Built fast, accurate, index-free code search - demonstrated on leaked Claude Code sources, Linux kernel (100k files), and Chromium (500k files). A foundational code-search primitive for agents.

- [Adam](https://x.com/_overment/status/2039061635776618554) — 2026-04-02: 'The best architecture I've found for my personal system' - based on a dynamic dependency graph plus a heartbeat involving the LLM, code, and events.
...
- [Arnav Gupta](https://x.com/championswimmer/status/2039109862919905719) — 2026-04-01: With nicopreme's Pi extensions (pi-subagents, pi-messenger, pi-mcp-adapter, pi-web-access) you can build something far beyond Ralph/GStack/Conductor - 'the most magnificent slop machine possible' (tongue-in-cheek). Pi agent-harness extensions.

- [ℏεsam](https://x.com/hesamation/status/2038758029940654507) — 2026-03-31: Praises Ole Lehmann turning Karpathy's 'LLM Council' into a Claude skill where sub-agents critique your idea from different angles - a cure for AI sycophancy. Links 'How to finally trust Claude's advice (using Karpathy's LLM Council method)' - 5 AI advisors argue, anonymously review each other, and hand back a synthesized verdict.

- [Vox](https://x.com/voxyz_ai/status/2038677643000758466) — 2026-03-31: Parallel module development with the Codex app: give AI a strategy doc and have it break the project into independent modules, each with the exact prompt to paste into a new window + commands + shared state; one 'foreman' window writes a shared doc others read/update. M1 (UI/UX) given to Claude (better for UI), the rest on Codex. 'One window -> five windows; completeness went from close enough to actually done.'

- [Tom Dörr](https://x.com/tom_doerr/status/2038456589984690462) — 2026-03-30: Scans and blocks dangerous AI agent actions - github.com/cisco-ai-defense/defenseclaw. An agent-action guardrail/security tool.

- [Viv](https://x.com/vtrivedy10/status/2038346865775874285) — 2026-03-30: 'Let there be harnesses, each optimized for tasks models can't do alone.' All harness design overcomes agents becoming lazy/cutting corners or confused/stupid; today's issues include human under-specification + engineering for repeated task decomposition and looping to 'keep working.' deepagents' goal: everyone can build their own harness + agent. Links sysls 'How To Solve Problems Of Long Running, Autonomous Agentic Engineering Workflows.'

- [Erick](https://x.com/ericksky/status/2038301058338812119) — 2026-03-30: Tome - a macOS app for Obsidian users: transcribes Zoom/Meet/Teams meetings locally with AI (on-device, no cloud), detects speakers, and drops perfect Markdown notes into your vault - ready to hand to your agent. No API keys/subscriptions, private, open-source.
...
- [Meta Alchemist](https://x.com/meta_alchemist/status/2038222105654022325) — 2026-03-29: FULL GUIDE 'How To Transform Claude Code Into A Self-Evolving System' - a four-layer setup: cognitive core (a CLAUDE.md that programs how Claude thinks: grep-first decision framework, completion criteria), specialized subagents (architect + reviewer), path-scoped rules (security/api-design/performance that load only for matching files), and an evolution engine (memory + a skill that captures corrections/observations and graduates them into learned rules with verify: grep checks that auto-enforce). Includes settings.json permissions, slash commands (/review, /fix-issue, /evolve), a memory protocol, a session-by-session evolution loop, tests, FAQ (keep CLAUDE.md <150 lines), and a one-command setup script.
...
- [Suryansh Tiwari](https://x.com/suryanshti777/status/2037892411666645363) — 2026-03-29: Maps 21 agent design patterns: prompt chaining, routing, parallelization, reflection, tool use, planning, multi-agent; then memory management, learning/adaptation, MCP, goal monitoring, human-in-the-loop, RAG; and advanced: A2A, resource-aware optimization, reasoning techniques, guardrails, evaluation & monitoring, prioritization, exploration & discovery. Links Agentic-Design-Patterns.pdf.

- [Shann³](https://x.com/shannholmberg/status/2036461256006357409) — 2026-03-29: 'Karpathy's AutoResearch is changing how campaigns get optimized' - Ole Lehmann tested it on landing-page copy: 56% -> 92% pass rate overnight. Links 'How to 10x your Claude Skills (using Karpathy's autoresearch method)' - auto-improve any skill on autopilot (skills fail ~30% of the time unnoticed).

- [Rohit](https://x.com/rohit4verse/status/2036845273117581676) — 2026-03-26: 8,000-word writeup on harness engineering, 8 points: the interface is the agent's mind; the context window isn't a RAM slot (noise competes with signal); cap search results (forces query refinement); lint at edit time not test time; a persistent progress file is the cheapest continuity fix; make completion criteria explicit and binary; one agent, one git worktree; your agent's ceiling is your feedback loop. Links 'The Harness Is Everything: What Cursor, Claude Code, and Perplexity Actually Built.'

- [Poonam Soni](https://x.com/codebypoonam/status/2036517669684519362) — 2026-03-25: 'Anthropic showed how they get Claude to build full apps in 6 hours without human intervention' - three agents, one prompt, production-quality output. Engagement-y framing of a multi-agent app-building architecture.

- [Greg Pstrucha](https://x.com/grichadev/status/2036472210152718504) — 2026-03-25: Skills are a real attack vector: demonstrates malicious skills hiding instructions to fool humans and agents (gricha.dev/blog/dangerous-skills); known scanners miss many. Favorites: hiding instructions inside a PNG, abusing Claude Code's 'expand output into skills.' Improved skill-scanner (getsentry/skills) + Warden. Guidance: write your own skills, use only trusted/pinned sources or have your agent resynthesize them, don't let agents pull new skills implicitly.

- [Millie Marconi](https://x.com/milliemarconnni/status/2036363493478375797) — 2026-03-25: A Claude Code skill that scans Reddit and X from the last 30 days on any topic and writes copy-paste-ready prompts from what the community has actually figured out. Type /last30days <topic> for top current patterns + a ready prompt; works for prompting, Midjourney, Suno, Cursor rules, etc. Open source, MIT.

- [Factory](https://x.com/factoryai/status/2036184745059688923) — 2026-03-24: Factory Missions now available to all users - long-running agents designed to automate large software tasks like building applications from scratch, migrations, and AI research.
...
- [charmaine](https://x.com/charmaine_klee/status/2055106811225931883) — 2026-05-15: Anthropic learnings on how Claude Code works in large codebases; links the 'best practices and where to start' blog.
...
- [Khairallah AL-Awady](https://x.com/eng_khairallah1/status/2054211760631185485) — 2026-05-14: Engagement-framed promo of a 30-min Boris Cherny session on using Claude Code, claiming most daily users miss 40+ features; links a 'Claude as full-time AI employee in 7 days' course.

- [darkzodchi](https://x.com/zodchiii/status/2054526937561796939) — 2026-05-13: An Anthropic engineer on why Claude Code users burn tokens (model switching, context management, waste-cutting settings); links '7 Claude Code Mistakes That Waste Your Tokens' (Claude Code resends full history every turn - a 30-message session burns ~232k tokens).

- [Avi Chawla](https://x.com/_avichawla/status/2054493154045567400) — 2026-05-13: Claude vs Claude Code vs Cowork: Chat for thinking, Code for building, Cowork for doing. Cowork is 'Claude Code for the rest of your work' - an agentic desktop assistant with direct local file access, scheduled tasks, Dispatch from phone, Computer Use, running in a sandboxed VM; all three in one $20/mo subscription.
...
- [klöss](https://x.com/kloss_xyz/status/2054096165055217987) — 2026-05-12: A full /goal prompt structure for Codex/Claude Code/Hermes: GOAL, CONTEXT, CONSTRAINTS, PRIORITY, PLAN (understand first, minimal changes), DONE WHEN, VERIFY (tests/build/lint + rollback), OUTPUT, and STOP RULES (halt on high-impact ambiguity, don't invent architecture, don't expand scope after the goal is met).
...
- [Mnimiy](https://x.com/mnilax/status/2053116311132155938) — 2026-05-10: Extends Forrest Chang's 4-rule Karpathy CLAUDE.md with 8 more (judgment-only model use, hard token budgets, surface-don't-average conflicts, read-before-write, tests verify intent, checkpoints, match conventions, fail loud), reporting a mistake-rate drop from 41% to 3% across 30 codebases. Notes CLAUDE.md is advisory and compliance falls off past ~200 lines / 14 rules.
...
- [Vox](https://x.com/voxyz_ai/status/2045899539526148193) — 2026-04-21: GitHub's #1 trending repo this week is a CLAUDE.md file (44,465 new stars) distilling Karpathy's LLM coding pitfalls into 4 principles: think before coding, simplicity first, surgical edits, goal-driven execution.
...
- [Noisy](https://x.com/noisyb0y1/status/2043609541477044439) — 2026-04-14: Long guide: 'Google engineer automated 80% of his work with Claude Code.' Part 1 Karpathy-principles CLAUDE.md (violations 40%->3%); Part 2 the 'Everything Claude Code' repo (30+ agents, 180+ skills, AgentShield); Part 3 a claim that Claude Code v2.1.100 charges ~20k more tokens server-side (downgrade fix). Case study: a dotnet app polls GitLab every 15 min, Claude classifies issues, subagents implement + open PRs. Several claims are hype/unverified.
...
- [0xMarioNawfal](https://x.com/roundtablespace/status/2040500903296352663) — 2026-04-06: 'MOST COMPLETE CLAUDE CODE SETUP OPEN SOURCED' - affaan-m/everything-claude-code: 27 agents, 64 skills, 33 commands + AgentShield (1,282 security tests); planning, code review, fixes, TDD, token optimization; works on Cursor/OpenCode/Codex CLI; free/open-source.
...
- [Denis Yurchak](https://x.com/denisyurchak/status/2036422883350544519) — 2026-03-25: Runs 6 Hetzner servers and made a .md prompt for a one-shot secure-VPS setup via Claude (usable with Termius): SSH, fail2ban, UFW firewall, optional Tailscale. Buy a Hetzner VPS, install Claude, give it the prompt. Shout-out to levelsio.
...
- [Mr. Buzzoni](https://x.com/polydao/status/2055197994635424038) — 2026-05-15: Engagement-farmed framing (fired Atlassian engineer posts a 38-min infrastructure breakdown 'free to copy'): Envoy proxy instead of enterprise load balancers, sidecar auth/logging/rate-limits, DynamoDB + SQS async provisioning, Packer + SaltStack automated VM deployments.
...
- [IndieDevHailey (开发者Hailey)](https://x.com/indiedevhailey/status/2054386235867812240) — 2026-05-13: RuView (open-source, 50k+ stars): uses ordinary home WiFi (CSI + AI) to sense people through walls - counts/positions, walking vs lying, 17-keypoint pose, breathing/heart rate while sleeping, and fall alerts - running locally with no cameras or wearables.
...
- [摆烂程序媛](https://x.com/wanerfu/status/2050158295911137370) — 2026-05-01: Scrapling (github.com/D4Vinci/Scrapling): scrape any site without being blocked - native Cloudflare bypass, no bot detection, no selectors to maintain, claimed 774x faster than BeautifulSoup, open-source.
...
- [Vaishnavi](https://x.com/_vmlops/status/2043624154646409708) — 2026-04-14: Google open-sourced Magika - AI file content-type detection run internally for years (Gmail, Drive, Safe Browsing). Detects what files really are regardless of extension (malware renamed .pdf, script disguised as image). 100M files trained, 200+ types, 99% accuracy, 5ms/file. pip install magika.
...
- [BuBBliK](https://x.com/k1rallik/status/2037936518862446694) — 2026-03-29: Personal story: $200/mo cloud APIs on an M2 MacBook, local models garbage past 4K tokens; applied 3-bit KV cache compression (TurboQuant) and now runs 100K-token conversations at cloud-identical quality, cancelled subscriptions. Links 'The algorithm that crashed Wall Street' - TurboQuant compresses AI memory 6x, 8x faster, zero accuracy loss (hype framing).

- [Suryansh Tiwari](https://x.com/suryanshti777/status/2037892411666645363) — 2026-03-29: Maps 21 agent design patterns: prompt chaining, routing, parallelization, reflection, tool use, planning, multi-agent; then memory management, learning/adaptation, MCP, goal monitoring, human-in-the-loop, RAG; and advanced: A2A, resource-aware optimization, reasoning techniques, guardrails, evaluation & monitoring, prioritization, exploration & discovery. Links Agentic-Design-Patterns.pdf.

- [Cheng Lou](https://x.com/_chenglou/status/2037713766205608234) — 2026-03-29: Announces a fast, accurate, comprehensive userland text-measurement algorithm in pure TypeScript - lay out entire web pages without CSS, bypassing DOM measurements and reflow. A foundational UI-engineering primitive.
...
- [How To AI](https://x.com/howtoai_/status/2054611399792644386) — 2026-05-15: Hype-framed claim that Google's 'Nested Learning' paper ('Attention Is All You Need V2') ends the Transformer era: treats a model as thousands of nested optimization problems to enable test-time learning without catastrophic forgetting; new HOPE architecture claims 100% long-context memory stability.

- [ar0cket1](https://x.com/ar0cket1/status/2054108160450064571) — 2026-05-15: Deep technical research notes on On-Policy Self-Distillation (OPSD) - aiming for RL-like ceiling with OPD sample efficiency toward continual learning. Findings on Olmo 3 7B: OPSD has larger/more frequent KL shocks and a stubborn 'positive pressure' gap vs OPD; GEPA hint optimization reduced shocks but couldn't close it.

- [divyansh tiwari](https://x.com/divyansht91162/status/2054430633645293687) — 2026-05-14: NanoResearch: an architecture for agents that continuously evolve around the user via three co-evolving layers - Skill Bank (repeated actions -> reusable expertise), Memory Layer (project/user experience across sessions), and Policy Learning (free-form feedback -> permanent behavioral updates).

- [송준 Jun Song](https://x.com/jun_song/status/2054379887608402199) — 2026-05-14: Hype-y local-LLM claim that a 128GB Mac will soon run an 'uncensored Opus-4.6' locally (a cracked Minimax variant), with the community fitting models into 24GB VRAM.
...
- [Vinay](https://x.com/leashless/status/2051437380788158739) — 2026-05-05: [Post unavailable — login-walled / protected account]

- [Tom Doerr](https://x.com/tom_doerr/status/2050312101504094651) — 2026-05-02: Points to a curated GitHub list on AI agent evolution, memory systems, and self-improvement (github.com/EvoMap/awesome-agent-evolution) — a reference index for the self-improving-agent literature.

- [Xiuyu Li](https://x.com/sheriyuo/status/2050067900820840791) — 2026-05-02: Xiuyu Li recommends will brown's 'On SFT, RL, and on-policy distillation' (with Claude Opus 4.7) - why the SFT-RL pipeline works, where on-policy distillation fits, and how self-distillation goes wrong.
...
- [Qwen](https://x.com/alibaba_qwen/status/2049861145574690992) — 2026-05-01: Qwen released Qwen-Scope, an open suite of sparse autoencoders for the Qwen family turning SAE features into tools: steer outputs by manipulating internal features (no prompt engineering), classify/synthesize targeted data, trace code-switching/repetition to source, and analyze feature activations for smarter benchmarks.
...
- [Guri Singh](https://x.com/heygurisingh/status/2054405672176091449) — 2026-05-14: [Post unavailable — account suspended]

- [송준 Jun Song](https://x.com/jun_song/status/2054379887608402199) — 2026-05-14: Hype-y local-LLM claim that a 128GB Mac will soon run an 'uncensored Opus-4.6' locally (a cracked Minimax variant), with the community fitting models into 24GB VRAM.

- [Jamie Signorile](https://x.com/sigsnyc/status/2054238175758111156) — 2026-05-14: 'AI Doesn't Make Anyone Good. It Makes Good People Harder to Catch' - a framework for where enterprise GTM roles are headed: a technical-fluency x commercial-acumen map, roles converging on the Forward Deployed Engineer archetype, and technical curiosity as the variable AI amplifies. Author built an underwriting agent cutting manual workflows 90%.

- [Michael Eisenberg](https://x.com/mikeeisenberg/status/2054431554240201008) — 2026-05-13: Recommends 'When Knowledge Is Cheap, Insight Is Everything' - applying Jevons paradox (cheaper resource -> more use) to argue that as AI makes knowledge cheap, insight becomes the scarce, valuable thing.

- [ericosiu](https://x.com/ericosiu/status/2054413343776223393) — 2026-05-13: Hiring forward deployed engineers worldwide via a 'beat AI' challenge; quotes Aaron Levie that FDEs are becoming one of the most in-demand jobs in tech because deploying agents is far more technical than people realize.

- [Founder Thoughts & Strategies](https://x.com/mogulinfluence/status/2054274159706853837) — 2026-05-13: 'How the best product teams will be built (and ship 10x faster) in the AI era'; quotes 'Building, and Whatnot' (31,832 PM applicants in two years, one hired).
...
- [Dave Kline](https://x.com/dklineii/status/2050563237490344194) — 2026-05-02: Management playbook: 95% of work problems come from unclear expectations; a simple 15-minute process to get and stay aligned.
...
- [Allie K. Miller](https://x.com/alliekmiller/status/2041577000804991485) — 2026-04-07: A hiring/onboarding maturity framework (from Alex/Steph, AI parts added): being AI-first means nothing without solving real business problems - use AI for faster experimentation, shorter iteration, better outcomes, else you're wasting tokens. Levels: many heavy users stuck at 2 (surface user); most interviewees at 3 (solution- not action-oriented); wants people to start at 4 (action + tradeoffs) and earn 5 (full ownership). AI makes your job bigger, not smaller.

- [Eric Siu](https://x.com/ericosiu/status/2040785346120859946) — 2026-04-06: 'Every org needs a world intelligence to operate at 10x.' Links 'How to practically deploy Jack Dorsey's world intelligence today' - Dorsey published an AI-native-company blueprint; author has run a version for 4 months powering 50+ daily workflows, coordinating decisions, surfacing issues.

- [Dave Kline](https://x.com/dklineii/status/2040776601223246334) — 2026-04-06: 'My 1:1s were broken for years' - cancelled on best people, used them as live status reports, did most of the talking. 4 tests to know if your 1:1s are actually working.
...
- **2026-05-15** | [Ole Lehmann](https://x.com/itsolelehmann/status/2055290989577753034) | agent-design, dev-practices, skills-mcp
  Nine workflows to build first to make Hermes a real Chief of Staff: daily brief, self-improving viral swipe file, trending-workflows radar, meeting-prep briefing, a 'Humanizer' that strips AI writing tells, bookmark inbox (X bookmarks -> tagged Obsidian notes), customer-support cron, weekly business report, and an Obsidian LLM-wiki second brain.

- **2026-05-15** | [0xMarioNawfal](https://x.com/roundtablespace/status/2055268207221682640) | agent-design, dev-practices, skills-mcp
  SocratiCode gives an AI deep semantic understanding of a codebase (dependency graphs, symbol-level impact analysis, cross-project search, zero config): 61% less context, 84% fewer tool calls, 37x faster than grep-based exploration, tested on 40M lines, fully local.

- **2026-05-15** | [Arpit Bhayani](https://x.com/arpit_bhayani/status/2055265636390207784) | dev-practices, research, agent-design
  Deep dive on what production-grade RAG actually requires beyond demos: chunking (where most systems fail), embedding-model lock-in, reindexing, document registries and chunk identity, index updates, and tracing/observability. RAG usually fails on indexing/retrieval/observability, not the model.

- **2026-05-15** | [Khairallah AL-Awady](https://x.com/eng_khairallah1/status/2055215784092401966) | agent-design, claude-code, management
  A full course on building multi-agent teams, framed around Anthropic's May 2026 multi-agent orchestration for Claude Managed Agents (up to 20 parallel agents; Netflix/Harvey/Shopify). Three patterns (pipeline, fan-out, specialist team), standardized output formats, Dreaming for cross-session memory (~6x completion gains at Harvey), rubric-based Outcomes, and incremental testing. Notes Cowork was built on this architecture.

- **2026-05-15** | [Mr. Buzzoni](https://x.com/polydao/status/2055197994635424038) | dev-practices, questionable
  Engagement-farmed framing (fired Atlassian engineer posts a 38-min infrastructure breakdown 'free to copy'): Envoy proxy instead of enterprise load balancers, sidecar auth/logging/rate-limits, DynamoDB + SQS async provisioning, Packer + SaltStack automated VM deployments.

- **2026-05-15** | [CyrilXBT](https://x.com/cyrilxbt/status/2055183411619549265) | industry, dev-practices, agent-design
  GitHub's official 'Agentic AI Developer' certification (GH-600) - the first formal credential for operating, supervising, and integrating AI agents across the SDLC, framed as recognizing agent-team work as an engineering discipline.

- **2026-05-15** | [charmaine](https://x.com/charmaine_klee/status/2055106811225931883) | claude-code, dev-practices
  Anthropic learnings on how Claude Code works in large codebases; links the 'best practices and where to start' blog.

- **2026-05-15** | [Meenakshi Yadav](https://x.com/meenakshiyacs/status/2055104295641710718) | agent-design, general
  A cheat sheet for designing/explaining Agentic AI architecture: goal, orchestration layer, agents layer, tools layer, memory (short + long-term), monitoring, reliability & failure (retries/fallbacks/human-in-the-loop), and governance & security. 'Agents alone don't make systems powerful; architecture does.'
...
- **2026-05-15** | [Avid](https://x.com/av1dlive/status/2054948286403150017) | agent-design, dev-practices, claude-code
  Two Airbnb senior staff engineers gave a live lecture on agentic coding (Airbnb shipped a major production LLM-agent migration); links a 'How to Build AI Agents in 2026' course arguing most builders ship demos, not production agents.

- **2026-05-15** | [Berryxia.AI](https://x.com/berryxia/status/2054924976835510337) | agent-design, research
  Tencent AI open-sourced an agent-memory system after 6 months on context loss in long sessions: real-time compression of stale context (61% fewer tokens), a mermaid-based structured task map (fewer lost trajectories in 30+ step flows), and dedicated Persona memory (consistency 48->76%).

- **2026-05-15** | [Petra Donka](https://x.com/petradonka/status/2054897826149101588) | agent-design, prompting, management
  'Agents Need Feedback Loops, Not Perfect Prompts' - Warp's 'Buzz' monitors mentions and drafts replies while learning from the team. Lessons: principles beat rules; feedback isn't learning unless the agent generalizes (a separate skill turns corrections into transferable principles); the feedback loop must live where the team works (Slack emoji + daily PR); treat agent skills like code.

- **2026-05-15** | [How To AI](https://x.com/howtoai_/status/2054611399792644386) | research, questionable
  Hype-framed claim that Google's 'Nested Learning' paper ('Attention Is All You Need V2') ends the Transformer era: treats a model as thousands of nested optimization problems to enable test-time learning without catastrophic forgetting; new HOPE architecture claims 100% long-context memory stability.

- **2026-05-15** | [Anatoli Kopadze](https://x.com/anatolikopadze/status/2054568935274549597) | claude-code, prompting, general
  'How to Actually Use Claude. 18 steps' - a setup-and-usage guide: Projects + who-you-are template + Custom Instructions; treat Claude as a thinking partner and sparring partner; style cloning; Extended Thinking; token-efficiency habits; plus ready prompts (Feynman analogies, expense analysis, business-idea stress test).
...
- **2026-05-14** | [Rohit Ghumare](https://x.com/ghumare64/status/2054625511897489423) | agent-design, dev-practices
  On why agent architecture matters: codebases that survive past month six do so because the architecture makes the bad shape unexpressible (not team discipline). Four canonical month-six failures and the Worker/Function/Trigger 'React-of-2013' fix; cites the Claude Code April 2026 postmortem (runtime changes cut median thinking length 73%, pushed retries up 80x).

- **2026-05-14** | [divyansh tiwari](https://x.com/divyansht91162/status/2054430633645293687) | agent-design, research
  NanoResearch: an architecture for agents that continuously evolve around the user via three co-evolving layers - Skill Bank (repeated actions -> reusable expertise), Memory Layer (project/user experience across sessions), and Policy Learning (free-form feedback -> permanent behavioral updates).
...
- **2026-05-14** | [Joe Hudson](https://x.com/fu_joehudson/status/2054264609683689941) | management, general
...
- **2026-05-14** | [Jamie Signorile](https://x.com/sigsnyc/status/2054238175758111156) | management, industry, agent-design
  'AI Doesn't Make Anyone Good. It Makes Good People Harder to Catch' - a framework for where enterprise GTM roles are headed: a technical-fluency x commercial-acumen map, roles converging on the Forward Deployed Engineer archetype, and technical curiosity as the variable AI amplifies. Author built an underwriting agent cutting manual workflows 90%.
...
- **2026-05-14** | [Jaynit](https://x.com/jaynitx/status/2054200520575967698) | general, management, prompting
...
- **2026-05-13** | [Alfred Lin](https://x.com/alfred_lin/status/2054556828118245710) | management, general
  Five methods to complement simplicity without confusing it with reality: face the limits of a framework, zoom in and out, check convergence across frameworks, think probabilistically, and hold conclusions humbly. Links 'Beware of Reductionist Thinking.'

- **2026-05-13** | [darkzodchi](https://x.com/zodchiii/status/2054526937561796939) | claude-code, dev-practices
  An Anthropic engineer on why Claude Code users burn tokens (model switching, context management, waste-cutting settings); links '7 Claude Code Mistakes That Waste Your Tokens' (Claude Code resends full history every turn - a 30-message session burns ~232k tokens).

- **2026-05-13** | [Avi Chawla](https://x.com/_avichawla/status/2054493154045567400) | claude-code, general
  Claude vs Claude Code vs Cowork: Chat for thinking, Code for building, Cowork for doing. Cowork is 'Claude Code for the rest of your work' - an agentic desktop assistant with direct local file access, scheduled tasks, Dispatch from phone, Computer Use, running in a sandboxed VM; all three in one $20/mo subscription.

- **2026-05-13** | [Ihtesham Ali](https://x.com/ihtesham2005/status/2054458335215395223) | research, agent-design, claude-code
  A Google+Meta paper where Claude Code proposes, tests, and refines its own reasoning algorithms with no human in the loop after setup - in 5 rounds discovering a controller with four coordinated mechanisms 'difficult to arrive at through manual intuition alone,' for a total discovery cost of $39.90.

- **2026-05-13** | [Michael Eisenberg](https://x.com/mikeeisenberg/status/2054431554240201008) | general, management, industry
  Recommends 'When Knowledge Is Cheap, Insight Is Everything' - applying Jevons paradox (cheaper resource -> more use) to argue that as AI makes knowledge cheap, insight becomes the scarce, valuable thing.

- **2026-05-13** | [ericosiu](https://x.com/ericosiu/status/2054413343776223393) | industry, management
  Hiring forward deployed engineers worldwide via a 'beat AI' challenge; quotes Aaron Levie that FDEs are becoming one of the most in-demand jobs in tech because deploying agents is far more technical than people realize.

- **2026-05-13** | [IndieDevHailey (开发者Hailey)](https://x.com/indiedevhailey/status/2054386235867812240) | research, dev-practices
  RuView (open-source, 50k+ stars): uses ordinary home WiFi (CSI + AI) to sense people through walls - counts/positions, walking vs lying, 17-keypoint pose, breathing/heart rate while sleeping, and fall alerts - running locally with no cameras or wearables.

- **2026-05-13** | [Miles Deutscher](https://x.com/milesdeutscher/status/2054310749884002348) | skills-mcp, questionable
  Promotes an 'agent skills marketplace' claiming over a million ready-to-use skills and plug-ins (search a type, hundreds of files appear). Volume-hype framing.

- **2026-05-13** | [Founder Thoughts & Strategies](https://x.com/mogulinfluence/status/2054274159706853837) | management, industry
  'How the best product teams will be built (and ship 10x faster) in the AI era'; quotes 'Building, and Whatnot' (31,832 PM applicants in two years, one hired).

- **2026-05-13** | [GREG ISENBERG](https://x.com/gregisenberg/status/2054261832718889216) | agent-design, management, industry
  A free 47-min course on building a managed AI-agent business solo: sell a 'digital employee' (unlimited agents/usage, infra+security included), don't niche down too fast, solve universal exec pain first, and use a Hermes + Codex/Claude Code + Orgo + Composio + Agent Mail + Obsidian stack (GPT-5.5 default, GLM 5.1 for cheap tasks).

- **2026-05-13** | [Joseph Viviano](https://x.com/josephdviviano/status/2054253118943363506) | agent-design, dev-practices, research
  'Agentic Research Best Practices' - using coding agents for research (vs engineering): research code must be reproducible, understandable, correct, and fully understood, not production-grade. Workflow of paper.tex/design_doc.md -> roadmap -> task plans, short AGENT.md, separate planning/implementation/verification agents, notes.md, commit-per-TODO (git as savegames), worktrees, and constraining diffs. Reports 2-10x iteration speedups.

- **2026-05-13** | [Charly Wargnier](https://x.com/datachaz/status/2054225085100151163) | agent-design, management, industry
  'Karpathy was right - 90% of AI advice dies in 6 months'; links Rohit's 'What to Learn, Build, and Skip in AI Agents (2026)' on separating signal from noise amid endless frameworks and '10x' launches.

- **2026-05-13** | [George from prodmgmt.world](https://x.com/nurijanian/status/2054216035503587396) | skills-mcp, prompting, dev-practices
  Wishes someone would productize his repeated 'AI skill-building pipeline for non-experts' (built two AI skills from two PDFs plus a tool) instead of stitching it across tools and skills.

- **2026-05-13** | [コムテ (Komte)](https://x.com/commte/status/2054136870016356408) | skills-mcp, industry
  Google's official Skills have arrived: 13 skills, standard-compliant with Agent Skills and supported by Claude Code, Antigravity, Gemini CLI, Cursor, and GitHub Copilot (github.com/google/skills).

- **2026-05-12** | [Ronin](https://x.com/deronin_/status/2054255152555545079) | dev-practices, claude-code, prompting
  10 things senior AI engineers stopped wasting tokens on (auto-loading files, running Opus on trivial tasks, retry loops re-sending the repo, Sonnet-by-default, streaming on stable prefixes, 'just in case' includes, per-session knowledge rebuilding, single premium tier, one-at-a-time questions, redundant subscriptions) - what compounds is context discipline, prompt caching, and multi-model routing. Links 'Cut Your AI Coding Bill by 80%.'
...
- **2026-05-12** | [klöss](https://x.com/kloss_xyz/status/2054096165055217987) | prompting, claude-code, dev-practices
  A full /goal prompt structure for Codex/Claude Code/Hermes: GOAL, CONTEXT, CONSTRAINTS, PRIORITY, PLAN (understand first, minimal changes), DONE WHEN, VERIFY (tests/build/lint + rollback), OUTPUT, and STOP RULES (halt on high-impact ambiguity, don't invent architecture, don't expand scope after the goal is met).
...
- **2026-05-10** | [Garry Tan](https://x.com/garrytan/status/2053127519872614419) | agent-design, skills-mcp, claude-code
  'Meta-Meta-Prompting' - personal AI as an operating system: a 100k-page 'brain,' a book-mirror pipeline, and a Skillify meta-skill that turns repeated workflows into composable, tested skills. Thin harness (OpenClaw), fat skills (100+), fat data, interchangeable models. Open-sourced as GStack/GBrain; thesis that the future belongs to individuals who build compounding AI systems.

- **2026-05-10** | [Mnimiy](https://x.com/mnilax/status/2053116311132155938) | claude-code, dev-practices, prompting
  Extends Forrest Chang's 4-rule Karpathy CLAUDE.md with 8 more (judgment-only model use, hard token budgets, surface-don't-average conflicts, read-before-write, tests verify intent, checkpoints, match conventions, fail loud), reporting a mistake-rate drop from 41% to 3% across 30 codebases. Notes CLAUDE.md is advisory and compliance falls off past ~200 lines / 14 rules.
...
- **2026-05-05** | [Vinay](https://x.com/leashless/status/2051437380788158739) | research, general
  [Post unavailable — login-walled / protected account]

- **2026-05-05** | [Adam Ghowiba](https://x.com/adamghowiba/status/2050886233921061281) | agent-design, industry, dev-practices
  JP Morgan's investment-research team shared how they built their 'Ask David' multi-agent system - the increasingly canonical pattern: supervisor orchestrator, specialized subagents for retrieval/structured-data/analytics, an LLM-as-judge reflection node before shipping, and human-in-the-loop for the last accuracy gap.

- **2026-05-02** | [Dave Kline](https://x.com/dklineii/status/2050563237490344194) | management
  Management playbook: 95% of work problems come from unclear expectations; a simple 15-minute process to get and stay aligned.

- **2026-05-02** | [Ole Lehmann](https://x.com/itsolelehmann/status/2050548948419645488) | prompting, management, agent-design
...
- **2026-05-02** | [Blaze](https://x.com/browomo/status/2050509770604331510) | agent-design, dev-practices
  A French teenager built a voice+gesture-controlled 3D map of his knowledge via Claude + Google Antigravity - no VR/controllers. Stack: Three.js, MediaPipe Hands, local Whisper, Claude API, assembled in a weekend. 217 mental models, 1,284 connections, 80ms gesture-to-redraw, ~1.4s voice-to-graph, zero mouse clicks. A clean prototype of a future PKM system.

- **2026-05-02** | [Muhammad Ayan](https://x.com/socialwithaayan/status/2050484688968724820) | dev-practices, agent-design
  Repo share: warpdotdev/warp - 'an agentic development environment, born out of the terminal.'

- **2026-05-02** | [Kpaxs](https://x.com/kpaxs/status/2050470605804216695) | management, general
  On agency: 'Low-agency asks Can I? High-agency says I'm doing this unless someone stops me.' Most permissions are granted retroactively - easier to get forgiveness than permission; much organizational authority was never formally granted, just assumed and later legitimized because it worked.

- **2026-05-02** | [Om Patel](https://x.com/om_patel5/status/2050441119003971683) | skills-mcp, agent-design, dev-practices
  Engagement-y claim that /graphify makes Claude 71.5x more token-efficient at understanding a codebase - maps every function/dependency upfront, extracts structure locally, transcribes media via Whisper, uses Claude + subagents for docs/images, tags relationships EXTRACTED/INFERRED/AMBIGUOUS, exports HTML/JSON. Handles 25 languages, PDFs, SQL, docx/xlsx; post-commit hooks rebuild the graph. 40k stars.
...
- **2026-05-02** | [Keith Rabois](https://x.com/rabois/status/2050250243552239956) | management, industry
  Keith Rabois flags Ann Miura-Ko's 'Everyone wants to be AI-pilled. Most Companies Are Still Level 1' - office visits to scaled companies (e.g. Ramp) vs AI-native startups, framing a maturity-level view of AI adoption.

- **2026-05-02** | [Dan Shipper](https://x.com/danshipper/status/2050235671466606665) | management, dev-practices, agent-design
  Dan Shipper flags Marcus's 'definitive' AI product-management guide (every.to) - a former PM shipping product like a madman with coding agents.

- **2026-05-02** | [regent0x](https://x.com/regent0x_/status/2050143341656838449) | agent-design, claude-code, dev-practices
  Story of a solo contractor making $320k/yr with 5 parallel specialist Claude Code agents (architect/coder/reviewer/tester/ops) that don't share context and coordinate via a shared task queue - taking team-sized projects solo, ~13x return on API spend. 'Don't compete with teams; become the team.'

- **2026-05-02** | [Xiuyu Li](https://x.com/sheriyuo/status/2050067900820840791) | research
  Xiuyu Li recommends will brown's 'On SFT, RL, and on-policy distillation' (with Claude Opus 4.7) - why the SFT-RL pipeline works, where on-policy distillation fits, and how self-distillation goes wrong.

- **2026-05-02** | [GPT Maestro](https://x.com/gptmaestro/status/2050060105052561681) | research, prompting, agent-design
  Points to 'Exploring GEPA' - how GEPA optimizes prompts/programs before inference (rather than cramming more context), addressing the same limitation RLMs target.

- **2026-05-02** | [Mike Bespalov](https://x.com/bbssppllvv/status/2049924037111841027) | skills-mcp, dev-practices, agent-design
  'Agents make ugly UIs because they've never seen good design.' Released 2,000 DESIGN.md files from the world's best products, structured for a model to read - colors, type, spacing, layouts. Free at styles.refero.design.
...
- **2026-05-01** | [Allen Braden](https://x.com/allen_explains/status/2050163013165224332) | questionable, research
  Claims a Jane Street junior landed a $220-600K role using AI on trillions of data points, with a 1-hour lecture. A Community Note corrects it: the video is actually a 2024 Horace He talk on ML systems/infrastructure (guest speaker, not employee); the trading/hiring story is fabricated.

- **2026-05-01** | [摆烂程序媛](https://x.com/wanerfu/status/2050158295911137370) | dev-practices, skills-mcp
  Scrapling (github.com/D4Vinci/Scrapling): scrape any site without being blocked - native Cloudflare bypass, no bot detection, no selectors to maintain, claimed 774x faster than BeautifulSoup, open-source.

- **2026-05-01** | [Teknium](https://x.com/teknium/status/2050098631907434871) | agent-design, dev-practices, prompting
  New Hermes feature (inspired by ralph loops and Codex's /goal): /goal <prompt> runs a loop with a supervisor model checking whether the task completed at the end of each agent loop, forcing it to continue until done. PR linked.

- **2026-05-01** | [Qwen](https://x.com/alibaba_qwen/status/2049861145574690992) | research
  Qwen released Qwen-Scope, an open suite of sparse autoencoders for the Qwen family turning SAE features into tools: steer outputs by manipulating internal features (no prompt engineering), classify/synthesize targeted data, trace code-switching/repetition to source, and analyze feature activations for smarter benchmarks.

### Apr 2026

- **2026-04-30** | [Garry Tan](https://x.com/garrytan/status/2049720409965392052) | skills-mcp, agent-design, dev-practices
  Garry Tan shipping GBrain quality-of-life PRs needed to make it work on a brain pushing 74k markdown files.

- **2026-04-30** | [How To AI](https://x.com/howtoai_/status/2049567036003795269) | research, prompting, agent-design
  'Tencent killed fine-tuning and RL with an $18 budget' via Training-Free GRPO: instead of updating weights (expensive, causes base-model amnesia), extract the 'semantic advantage' of why one answer beat another, compress it into a 'token prior,' and attach it in the API call. On DeepSeek-V3, a few dozen samples produced a specialized expert outperforming fine-tuned models - zero parameter updates. Hype framing but a real technique.
...
- **2026-04-30** | [Darshak Rana](https://x.com/thedarshakrana/status/2049151671692136778) | general, management
...
- **2026-04-21** | [Shubham Saboo](https://x.com/saboo_shubham_/status/2046473615118672325) | agent-design, skills-mcp, dev-practices
  Repo share: codejunkie99/agentic-stack - 'One brain, many harnesses. Portable .agent/ folder (memory + ...)' - a portable agent memory/config folder usable across harnesses.

- **2026-04-21** | [Tech with Mak](https://x.com/technmak/status/2046414820241760620) | research, dev-practices, agent-design
  'Meta solved RAG's biggest bottleneck' - REFRAG compresses context chunks into single embeddings (process ~1,024 chunk embeddings instead of 16,384 tokens), exploiting sparse attention in RAG contexts via cached embeddings + an RL-based compression policy. Claims 30.85x faster time-to-first-token, zero perplexity loss, 16x context extension, no architecture changes.
...
- **2026-04-21** | [Sydney Runkle](https://x.com/sydneyrunkle/status/2046277232537256002) | agent-design, dev-practices, research
  'The runtime behind production deep agents' - harness (prompts/tools/skills) vs runtime (durable execution, memory, multi-tenancy, observability). Walks LangSmith Deployment / Agent Server: checkpointed durable execution, short- vs long-term memory, auth/RBAC/Agent Auth, human-in-the-loop (interrupt/resume), streaming + double-texting strategies, middleware guardrails, tracing + online evals (+13.7 pts on Terminal Bench 2.0 from harness changes alone), time travel, sandboxed code execution, MCP/A2A/webhooks, and cron. Packaged by 'deepagents deploy' as an open, MIT-licensed harness.

- **2026-04-21** | [Nav Toor](https://x.com/heynavtoor/status/2046276160930414976) | research, dev-practices, agent-design
  'PoisonedRAG': researchers showed 5 documents planted in a 2.6M-document database can hijack an LLM's answer 97% of the time - the attacker never touches the model or retriever, just writes a document. A retrieval-layer trust vulnerability.

- **2026-04-21** | [Simplifying AI](https://x.com/simplifyinai/status/2046271932035645599) | research, agent-design
  'Microsoft solved the context window problem' - paper MEMENTO teaches models to forget: reason in blocks, write a dense summary ('memento') after each, then physically delete the previous block from the KV cache and carry only the memento forward. Claims 6x context compression, 2.5x less KV-cache memory, zero accuracy loss - enabling local multi-step agents.

- **2026-04-21** | [Sigrid Jin](https://x.com/realsigridjin/status/2046266374948069387) | dev-practices, agent-design, questionable
  Points to a harness method from someone who mass-merged into kubernetes/huggingface then got banned from GitHub: two stages did 80% of the work - reproduce the bug locally (or drop it) and read merge history instead of CONTRIBUTING.md. Links 'How I got banned from GitHub due to my harness pipeline' (500+ commits across 100+ repos in 72 hours -> suspension).
...
- **2026-04-21** | [Ihtesham Ali](https://x.com/ihtesham2005/status/2046197374855582157) | general, management
...
- **2026-04-17** | [0xSero](https://x.com/0xsero/status/2044879665001595263) | agent-design, dev-practices, claude-code
  0xSero 'went 180' on multi-agents/subagents after analyzing hundreds of AI coding sessions - it helps a lot. Links 'Single-agent AI coding is a nightmare for engineers' on the pain of one slow single agent.
...
- **2026-04-15** | [Garry Tan](https://x.com/garrytan/status/2044479509874020852) | agent-design, skills-mcp, claude-code
  'Resolvers: The Routing Table for Intelligence' - a resolver maps task/content types to which document/skill to load. Confession: a 20,000-line CLAUDE.md degraded the model; a ~200-line decision tree replaced it and improved everything. A misfiling revealed only 3 of 13 skills consulted the resolver; fix = shared filing rules + mandate. 'Invisible skill' problem (skills that exist but aren't reachable) -> trigger evals + a check-resolvable meta-skill (found 6 unreachable skills). Resolvers decay ('context rot'); endgame is an RLM rewriting them from traffic. Resolvers are fractal and are the governance/management layer of an agent 'organization.' Open-sourced in GBrain/GStack.
...
- **2026-04-15** | [Yoonho Lee](https://x.com/yoonholeee/status/2044442372864700510) | research, agent-design, dev-practices
  Released code for Meta-Harness (stanford-iris-lab/meta-harness) - a method for optimizing LLM harnesses end-to-end (long-horizon credit assignment over prior code/traces/scores). Point your agent at ONBOARDING.md to implement good Meta-Harnesses in new domains.

- **2026-04-15** | [Viv](https://x.com/vtrivedy10/status/2044430694458310870) | dev-practices, general
  On X you can learn directly from frontier builders; points to Hunter Leath for storage/filesystems alpha. Links 'Bash is the SQL for file systems' (egress fees, querying file systems).

- **2026-04-15** | [Shann³](https://x.com/shannholmberg/status/2044413638388363272) | agent-design, skills-mcp, dev-practices
  Connected an Obsidian knowledge base (230+ cross-referenced pages) to every project so every agent reads the wiki first: indexed with qmd (hybrid BM25 + vector + LLM re-ranking, local) and a global /knowledge-shann skill any agent can call to load voice rules, frameworks, and metrics before working. Same pattern for company/client KBs. All markdown, one CLI command, works with any bash-capable agent.

- **2026-04-15** | [Millie Marconi](https://x.com/milliemarconnni/status/2044358003714097601) | prompting, management, general
  'Inversion is the most powerful thinking tool most people never use correctly - they invert the goal, not the system.' Turned Claude into an inversion engine running Munger's method: map every path to failure so the path to success becomes obvious by elimination. Shares 5 prompts.
...
- **2026-04-15** | [0xSero](https://x.com/0xsero/status/2044165332928213243) | dev-practices, research
  Guide to running big models on small hardware: REAPs (up to 50% savings), quantizations (75%; AWQ/GPTQ/W4A16/FP8 fast, GGUF/EXL3 slower, MLX best for Apple), and 8-bit KV cache (50-75%).
...
- **2026-04-14** | [Akshay](https://x.com/akshay_pachaar/status/2043745099792953508) | agent-design, research, dev-practices
  'Build Agents that never forget' - a first-principles walk through agent memory. LLMs are stateless; 7 failure modes without memory; bigger context isn't the fix ('lost in the middle'). Cognitive-science frame (sensory/working/long-term; episodic/semantic/procedural; consolidation). Layers from Python list -> markdown files -> vector search (each fixing then revealing a limit, e.g. vectors miss multi-hop 'bridge' facts). Solution: Cognee, open-source engine combining relational + vector + graph stores in four calls (add/cognify/memify/search), deduped knowledge graph with dual indexing, RL-inspired memify, 14 retrieval modes.

- **2026-04-14** | [Alex Finn](https://x.com/alexfinn/status/2043719233213980922) | prompting, agent-design, claude-code
  'Read a tweet, give it to your agent, and it upgrades.' Copy-paste SOUL.md prompt (from Garry Tan): 'The marginal cost of completeness is near zero with AI. Do the whole thing, do it right, with tests and docs... never present a workaround when the real fix exists. Search before building, test before shipping, ship the complete thing.'
...
- **2026-04-14** | [Vaishnavi](https://x.com/_vmlops/status/2043624154646409708) | dev-practices, research, skills-mcp
  Google open-sourced Magika - AI file content-type detection run internally for years (Gmail, Drive, Safe Browsing). Detects what files really are regardless of extension (malware renamed .pdf, script disguised as image). 100M files trained, 200+ types, 99% accuracy, 5ms/file. pip install magika.

- **2026-04-14** | [Noisy](https://x.com/noisyb0y1/status/2043609541477044439) | claude-code, dev-practices, questionable
  Long guide: 'Google engineer automated 80% of his work with Claude Code.' Part 1 Karpathy-principles CLAUDE.md (violations 40%->3%); Part 2 the 'Everything Claude Code' repo (30+ agents, 180+ skills, AgentShield); Part 3 a claim that Claude Code v2.1.100 charges ~20k more tokens server-side (downgrade fix). Case study: a dotnet app polls GitLab every 15 min, Claude classifies issues, subagents implement + open PRs. Several claims are hype/unverified.

- **2026-04-13** | [Garry Tan](https://x.com/garrytan/status/2043581361798500602) | prompting, agent-design, claude-code
  'New item in my SOUL.md tonight' (shared as an image) - the widely-quoted SOUL.md addition on the 'marginal cost of completeness is near zero with AI: do the whole thing, do it right, ship the complete thing, not a plan.'

- **2026-04-13** | [Defileo](https://x.com/defileo/status/2043437202190024912) | prompting, general, claude-code
  On f/prompts.chat (~159k stars, #33 most-starred repo): the 'I want you to act as...' role-prompt collection cited by Harvard/Columbia, proving people knew AI could be more than search. Contrast: a costume ('act as a therapist') vs a methodology (phased psychological excavation, 7-domain money audit targeting beliefs before numbers).

- **2026-04-13** | [Charly Wargnier](https://x.com/datachaz/status/2043246635996807300) | skills-mcp, dev-practices, agent-design
  Addy Osmani (Google) dropped Agent Skills: 19 engineering skills + 7 commands encoding senior-engineer quality gates across the lifecycle (Define/Plan/Build/Verify/Review/Ship) with slash commands (/spec /plan /build /test /review /code-simplify /ship). Bakes in Shift Left, Chesterton's Fence, Hyrum's Law; works with Claude Code/Cursor/Antigravity. npx skills add addyosmani/agent-skills.
...
- **2026-04-12** | [Nav Toor](https://x.com/heynavtoor/status/2043321909971202403) | agent-design, skills-mcp, research
  LLM Wiki v2 extends Karpathy's LLM Wiki with the features it lacked: confidence scoring (facts decay), memory tiers (working/episodic/semantic/procedural), a typed knowledge graph, hybrid search (BM25 + vector + graph, RRF-fused), automated hooks (auto-ingest/compress/decay), forgetting curves, and contradiction resolution by source recency/authority. Turns a flat wiki into a living memory that strengthens, weakens, consolidates, and forgets.

- **2026-04-12** | [Garry Tan](https://x.com/garrytan/status/2043198780800197025) | agent-design, management, skills-mcp
  'If your memory dies when your harness dies, you built the harness too thick.' Argues for thin harnesses: memory is markdown, skills are markdown, the 'brain' is a git repo, and the harness is a thin conductor that reads files it doesn't own. Endorses Harrison Chase's 'Your harness, your memory' article on harness/memory coupling and the risk of closed harnesses.

- **2026-04-12** | [Nick Spisak](https://x.com/nickspisak_/status/2043060265823146202) | claude-code, agent-design, dev-practices
  Claude Code shipped /ultraplan: sends planning to four Opus 4.6 cloud agents (three explorers + one critic) instead of one terminal agent. Covers why the review workflow matters more than the 4x speed, 5 scenarios where it prevents rework, and when to use local plan mode instead.

- **2026-04-12** | [Garry Tan](https://x.com/garrytan/status/2042919242283258072) | agent-design, skills-mcp, dev-practices
  New OpenClaw/Hermes users struggle with integrations, and you can't reach 1,000+ markdown files without proper mail/calendar integrations - GBrain now ships guided integration recipes on first install.

- **2026-04-11** | [Nav Toor](https://x.com/heynavtoor/status/2042879339256254689) | research, questionable, industry
  Kronos - first open-source foundation model for financial markets ('reads candlestick charts the way GPT reads English'). Trained on 12B records from 45 exchanges; price/volatility forecasting, zero-shot, 4 model sizes. Claims 93% accuracy gains (hype framing). Tsinghua, AAAI 2026, HuggingFace, MIT.

- **2026-04-10** | [Veeral Patel](https://x.com/vral/status/2042674854764130549) | research, agent-design
  'We'll look back on passing .md files between agents like mailing floppy disks.' Links Ramp Labs 'Latent Briefing: Efficient Memory Sharing for Multi-Agent Systems via KV Cache Compaction' - sharing compacted KV cache instead of text between agents to fix multi-agent token inefficiency.

- **2026-04-10** | [Alpha Batcher](https://x.com/alphabatcher/status/2042606770816704643) | agent-design, dev-practices
  Architectural principles for a production AI agent: async generator (streaming-native) not a while loop, read-only tools parallel / write tools serial, tools execute during generation, cache-efficient system prompt, hierarchical compaction, every error has an in-loop recovery path, each sub-agent gets an isolated worktree + context. 'Infrastructure is the fourth layer - without it you have a demo not a product.' Links Rohit's 'harness from Claude Code leaks' article.

- **2026-04-10** | [Akshay](https://x.com/akshay_pachaar/status/2042586319390674994) | agent-design, dev-practices, research
  What every big company thinks about the agent harness. Agreement: the model isn't the product, the infra around it is; disagreement: how thick. Anthropic bets thin ('dumb loop'); OpenAI Agents SDK code-first, slightly thicker; CrewAI adds a deterministic backbone; LangGraph bets on explicit graph control. Scaffolding metaphor - build infra designed to be removed as models improve, but remove carefully since models are trained WITH specific harnesses. Future-proofing test: a stronger model should improve performance without added harness complexity. LangChain changed only infra and jumped to rank 5 on TerminalBench 2.0. Links 'The Anatomy of an Agent Harness.'

- **2026-04-10** | [Vaishnavi](https://x.com/_vmlops/status/2042486942802321552) | skills-mcp, dev-practices, agent-design
  Google's MCP Toolbox - open-source MCP server giving agents plain-English access to 20+ databases (Postgres, MySQL, MongoDB, BigQuery, Redis, Elasticsearch, Spanner, Snowflake) with built-in pooling, auth, and OpenTelemetry; works with LangChain/LlamaIndex/Genkit/any MCP client; <10 lines to plug in.

- **2026-04-10** | [Sigrid Jin](https://x.com/realsigridjin/status/2042440330503733343) | agent-design, research, dev-practices
  On Viv's 'Better Harness' recipe: evals are the new training data (update the harness, not weights); agents reward-hack evals, so use strict train/test splits and holdout sets; quality over quantity of evals; the loop = mine prod traces for failures -> turn into evals -> auto-tweak prompts/tools -> validate -> more usage -> more evals -> self-improving agents.

- **2026-04-10** | [Teknium](https://x.com/teknium/status/2042396576245825543) | agent-design, dev-practices, claude-code
  Hermes added notify-when-done so a spawned background process queues a message back to the agent when finished (work on other things instead of polling). Quotes Claude's new Monitor tool doing the same. 'Open source can move faster than any closed company.'

- **2026-04-10** | [ProxySoul](https://x.com/bniwael/status/2042364421373121018) | agent-design, dev-practices, skills-mcp
...
- **2026-04-10** | [Seb Goddijn](https://x.com/sebgoddijn/status/2042286523001737545) | management, agent-design, industry
  'We hit 99% AI adoption at Ramp but it wasn't enough' - most people stuck in a chat window while power users ran laps. Built Glass, an AI productivity suite on Anthropic's Claude Agent SDK, 700 DAUs in a month. 'We don't lower the ceiling, we raise the floor.' Links 'We Built Every Employee at Ramp Their Own AI Coworker - The Models are Good Enough, The Harness Isn't.'

- **2026-04-10** | [Santiago](https://x.com/svpino/status/2042275938390639069) | research, agent-design, industry
  Large Memory Models - a new architecture designed for how human memory works (not RAG/vector search). Founders have 160+ Nature/ICLR publications and closed their Harvard lab to build it. Quotes Gabriel Kreiman introducing Engramme ('remember everything' - perfect/infinite memory with no searching/prompting).

- **2026-04-10** | [Avid](https://x.com/av1dlive/status/2042172428127002906) | skills-mcp, agent-design, dev-practices
  A 16-min talk by two Anthropic engineers who built Claude Skills on how to build them right. Links Khairallah's 'How to Build Claude Skills That Actually Work' (80,000+ registry skills, most terrible - fire on wrong requests, inconsistent output, break on edge cases).

- **2026-04-09** | [carsonfarmer](https://x.com/carsonfarmer/status/2042038527639068763) | agent-design, industry, research
  'So many AI-agent innovations are just Letta/MemGPT rediscovered.' Quotes Sarah Wooders: the new Anthropic managed-agents API is basically the year-old Letta API but closed-source with provider lock-in (even read-only memory blocks and memory-block sharing, long unique to Letta).

- **2026-04-09** | [Aakash Gupta](https://x.com/aakashgupta/status/2041984945380585785) | management, claude-code, agent-design
  Companies spending $200K/yr on AI seats with zero gains all make the same mistake: same foundation model, zero shared context. A 'Team OS' turns a GitHub repo into the team's collective brain for Claude (call summaries, specs, constraints, strategy docs). Compound effect: a team of 10 adding 2-3 artifacts/week => 250+ structured docs a quarter; a new hire gets a veteran's context in week one. DoorDash's Hannah Stulberg's team writes every doc in Claude Code, checks it in for review.

- **2026-04-09** | [Ashpreet Bedi](https://x.com/ashpreetbedi/status/2041966288541507861) | agent-design, research, dev-practices
  Praises Viv's auto-improving-systems approach ('give it to Claude Code and let it rip'). Links Viv's 'Better Harness: A Recipe for Harness Hill-Climbing with Evals' - build better agents by building better harnesses, using evals as the learning signal.

- **2026-04-09** | [mr-r0b0t](https://x.com/mr_r0b0t/status/2041930298238087464) | agent-design, research, dev-practices
  'Harness evolution + specialist local models will be the way forward.' Links Viv's 'Better Harness: A Recipe for Harness Hill-Climbing with Evals' (LangChain team).

- **2026-04-09** | [Justin Brooke](https://x.com/imjustinbrooke/status/2041890745167061245) | agent-design, skills-mcp, prompting
  If you don't know what SOUL.md, AGENTS.md, USER.md, TOOLS.md, MEMORY.md, HEARTBEAT.md, STYLE.md are and how to use them, learn. Quotes @agentskills_ai: 'these 7 text files will run your business in 2027; harnesses > models' (diesel-engine-without-wheels analogy).

- **2026-04-09** | [Vaishnavi](https://x.com/_vmlops/status/2041869776927261024) | dev-practices, skills-mcp, agent-design
  Microsoft MarkItDown - converts anything (PDF, Word, Excel, PowerPoint, audio, YouTube URLs) into clean structured markdown for LLMs; one pip install, no custom parsers. github.com/microsoft/markitdown.

- **2026-04-08** | [Sowmay Jain](https://x.com/sowmay_jain/status/2041982135305957425) | research, agent-design, industry
  Had his AI agent process his whole-genome sequence end to end: found a 2-year-old email + link, pulled 67GB raw DNA, rented a $5 machine, aligned 21M reads (99.83% mapped), called 5.8M variants via a two-pass neural net, phased maternal/paternal, annotated against ClinVar/PharmGKB/gnomAD, and produced a health-risk map (39 conditions), drug guide (141 meds), nutrient metabolism, and ancestry - $5, 8 hours, one instruction. Quotes 1B+ rows of psychiatric-genetics GWAS data on HuggingFace.
...
- **2026-04-07** | [Allie K. Miller](https://x.com/alliekmiller/status/2041577000804991485) | management
  A hiring/onboarding maturity framework (from Alex/Steph, AI parts added): being AI-first means nothing without solving real business problems - use AI for faster experimentation, shorter iteration, better outcomes, else you're wasting tokens. Levels: many heavy users stuck at 2 (surface user); most interviewees at 3 (solution- not action-oriented); wants people to start at 4 (action + tradeoffs) and earn 5 (full ownership). AI makes your job bigger, not smaller.

- **2026-04-06** | [Eric Siu](https://x.com/ericosiu/status/2040785346120859946) | management, agent-design, industry
  'Every org needs a world intelligence to operate at 10x.' Links 'How to practically deploy Jack Dorsey's world intelligence today' - Dorsey published an AI-native-company blueprint; author has run a version for 4 months powering 50+ daily workflows, coordinating decisions, surfacing issues.

- **2026-04-06** | [Dave Kline](https://x.com/dklineii/status/2040776601223246334) | management
  'My 1:1s were broken for years' - cancelled on best people, used them as live status reports, did most of the talking. 4 tests to know if your 1:1s are actually working.

- **2026-04-06** | [Alex Veremeyenko](https://x.com/alex_prompter/status/2040731938751914065) | research, agent-design, dev-practices
  Google DeepMind mapped the AI-agent attack surface (502 participants, 8 countries, 23 attack types). Manipulation is already happening at scale and defenses fail predictably/invisibly. Channels: prompt injection via HTML comments / white-on-white text, steganography in image pixels, image metadata, malicious PDFs, QR codes, indirect injection via search/calendar/email/API. Detection asymmetry: sites fingerprint agents and serve them manipulated content humans never see. Categories include memory poisoning, goal hijacking, exfiltration, cross-agent injection. All standard defenses fail at agent scale; multi-agent cascade propagates an injection with legitimate trust. 'Compromise the data the model consumes, not the model.'

- **2026-04-06** | [0xMarioNawfal](https://x.com/roundtablespace/status/2040500903296352663) | claude-code, skills-mcp, dev-practices
  'MOST COMPLETE CLAUDE CODE SETUP OPEN SOURCED' - affaan-m/everything-claude-code: 27 agents, 64 skills, 33 commands + AgentShield (1,282 security tests); planning, code review, fixes, TDD, token optimization; works on Cursor/OpenCode/Codex CLI; free/open-source.

- **2026-04-05** | [Ejaaz](https://x.com/cryptopunk7213/status/2040434869399138368) | agent-design, research, dev-practices
  On AutoAgent, a self-improving AI: agents suck because of the harness (tools/system prompts), not the model; a Meta agent tweaks the harness, runs tests, and improves until #1 at its goal - works for any task, using the same model to evaluate (Claude managing Claude). Links Kevin Gu's 'AutoAgent: first open source library for self-optimizing agents' (#1 SpreadsheetBench 96.5%, #1 GPT-5 TerminalBench).

- **2026-04-03** | [Charly Wargnier](https://x.com/datachaz/status/2039963758790156555) | agent-design, prompting, claude-code
  Breaks down Karpathy's self-improving second brain: instead of complex RAG, the LLM pulls raw research into an Obsidian markdown wiki and takes over index creation, linting, and Q&A routing. Dump sources -> LLM auto-compiles an indexed .md wiki -> ask questions -> it generates outputs (Marp slides, matplotlib) and files them back. Implication: agents maintaining their own memory layer need clean file organization + queryable indexes, not huge context. Quotes Karpathy's original 'LLM Knowledge Bases' post.
...
- **2026-04-01** | [Arnav Gupta](https://x.com/championswimmer/status/2039109862919905719) | agent-design, skills-mcp, dev-practices
  With nicopreme's Pi extensions (pi-subagents, pi-messenger, pi-mcp-adapter, pi-web-access) you can build something far beyond Ralph/GStack/Conductor - 'the most magnificent slop machine possible' (tongue-in-cheek). Pi agent-harness extensions.

### Mar 2026

- **2026-03-31** | [klöss](https://x.com/kloss_xyz/status/2038842907466334550) | dev-practices, industry, questionable
  Supply-chain attack on axios (100M+ weekly downloads): a hijacked maintainer account published poisoned versions that inject a fake dependency (plain-crypto-js) dropping a RAT (cross-platform payloads, self-destructing traces, bypassed CI/CD). One of the most sophisticated supply-chain attacks on a top-10 npm package. Guidance: pin to 1.14.0/0.30.3, rotate secrets, check for C2, add --ignore-scripts to CI.

- **2026-03-31** | [ℏεsam](https://x.com/hesamation/status/2038758029940654507) | skills-mcp, prompting, agent-design
  Praises Ole Lehmann turning Karpathy's 'LLM Council' into a Claude skill where sub-agents critique your idea from different angles - a cure for AI sycophancy. Links 'How to finally trust Claude's advice (using Karpathy's LLM Council method)' - 5 AI advisors argue, anonymously review each other, and hand back a synthesized verdict.

- **2026-03-31** | [Vox](https://x.com/voxyz_ai/status/2038677643000758466) | agent-design, dev-practices, claude-code
  Parallel module development with the Codex app: give AI a strategy doc and have it break the project into independent modules, each with the exact prompt to paste into a new window + commands + shared state; one 'foreman' window writes a shared doc others read/update. M1 (UI/UX) given to Claude (better for UI), the rest on Codex. 'One window -> five windows; completeness went from close enough to actually done.'

- **2026-03-30** | [Tom Dörr](https://x.com/tom_doerr/status/2038456589984690462) | agent-design, dev-practices, skills-mcp
  Scans and blocks dangerous AI agent actions - github.com/cisco-ai-defense/defenseclaw. An agent-action guardrail/security tool.

- **2026-03-30** | [Viv](https://x.com/vtrivedy10/status/2038346865775874285) | agent-design, dev-practices, research
  'Let there be harnesses, each optimized for tasks models can't do alone.' All harness design overcomes agents becoming lazy/cutting corners or confused/stupid; today's issues include human under-specification + engineering for repeated task decomposition and looping to 'keep working.' deepagents' goal: everyone can build their own harness + agent. Links sysls 'How To Solve Problems Of Long Running, Autonomous Agentic Engineering Workflows.'

- **2026-03-30** | [Erick](https://x.com/ericksky/status/2038301058338812119) | dev-practices, skills-mcp, agent-design
  Tome - a macOS app for Obsidian users: transcribes Zoom/Meet/Teams meetings locally with AI (on-device, no cloud), detects speakers, and drops perfect Markdown notes into your vault - ready to hand to your agent. No API keys/subscriptions, private, open-source.
...
- **2026-03-29** | [Meta Alchemist](https://x.com/meta_alchemist/status/2038222105654022325) | claude-code, agent-design, skills-mcp
  FULL GUIDE 'How To Transform Claude Code Into A Self-Evolving System' - a four-layer setup: cognitive core (a CLAUDE.md that programs how Claude thinks: grep-first decision framework, completion criteria), specialized subagents (architect + reviewer), path-scoped rules (security/api-design/performance that load only for matching files), and an evolution engine (memory + a skill that captures corrections/observations and graduates them into learned rules with verify: grep checks that auto-enforce). Includes settings.json permissions, slash commands (/review, /fix-issue, /evolve), a memory protocol, a session-by-session evolution loop, tests, FAQ (keep CLAUDE.md <150 lines), and a one-command setup script.
...
- **2026-03-29** | [BuBBliK](https://x.com/k1rallik/status/2037936518862446694) | research, dev-practices, questionable
  Personal story: $200/mo cloud APIs on an M2 MacBook, local models garbage past 4K tokens; applied 3-bit KV cache compression (TurboQuant) and now runs 100K-token conversations at cloud-identical quality, cancelled subscriptions. Links 'The algorithm that crashed Wall Street' - TurboQuant compresses AI memory 6x, 8x faster, zero accuracy loss (hype framing).

- **2026-03-29** | [Suryansh Tiwari](https://x.com/suryanshti777/status/2037892411666645363) | agent-design, dev-practices, skills-mcp
  Maps 21 agent design patterns: prompt chaining, routing, parallelization, reflection, tool use, planning, multi-agent; then memory management, learning/adaptation, MCP, goal monitoring, human-in-the-loop, RAG; and advanced: A2A, resource-aware optimization, reasoning techniques, guardrails, evaluation & monitoring, prioritization, exploration & discovery. Links Agentic-Design-Patterns.pdf.

- **2026-03-29** | [Cheng Lou](https://x.com/_chenglou/status/2037713766205608234) | dev-practices
  Announces a fast, accurate, comprehensive userland text-measurement algorithm in pure TypeScript - lay out entire web pages without CSS, bypassing DOM measurements and reflow. A foundational UI-engineering primitive.

- **2026-03-29** | [Shann³](https://x.com/shannholmberg/status/2036461256006357409) | skills-mcp, prompting, agent-design
  'Karpathy's AutoResearch is changing how campaigns get optimized' - Ole Lehmann tested it on landing-page copy: 56% -> 92% pass rate overnight. Links 'How to 10x your Claude Skills (using Karpathy's autoresearch method)' - auto-improve any skill on autopilot (skills fail ~30% of the time unnoticed).

- **2026-03-26** | [Rohit](https://x.com/rohit4verse/status/2036845273117581676) | agent-design, dev-practices, claude-code
  8,000-word writeup on harness engineering, 8 points: the interface is the agent's mind; the context window isn't a RAM slot (noise competes with signal); cap search results (forces query refinement); lint at edit time not test time; a persistent progress file is the cheapest continuity fix; make completion criteria explicit and binary; one agent, one git worktree; your agent's ceiling is your feedback loop. Links 'The Harness Is Everything: What Cursor, Claude Code, and Perplexity Actually Built.'

- **2026-03-25** | [Poonam Soni](https://x.com/codebypoonam/status/2036517669684519362) | agent-design, claude-code
  'Anthropic showed how they get Claude to build full apps in 6 hours without human intervention' - three agents, one prompt, production-quality output. Engagement-y framing of a multi-agent app-building architecture.

- **2026-03-25** | [Greg Pstrucha](https://x.com/grichadev/status/2036472210152718504) | skills-mcp, dev-practices, agent-design
  Skills are a real attack vector: demonstrates malicious skills hiding instructions to fool humans and agents (gricha.dev/blog/dangerous-skills); known scanners miss many. Favorites: hiding instructions inside a PNG, abusing Claude Code's 'expand output into skills.' Improved skill-scanner (getsentry/skills) + Warden. Guidance: write your own skills, use only trusted/pinned sources or have your agent resynthesize them, don't let agents pull new skills implicitly.

- **2026-03-25** | [Denis Yurchak](https://x.com/denisyurchak/status/2036422883350544519) | dev-practices, skills-mcp, claude-code
  Runs 6 Hetzner servers and made a .md prompt for a one-shot secure-VPS setup via Claude (usable with Termius): SSH, fail2ban, UFW firewall, optional Tailscale. Buy a Hetzner VPS, install Claude, give it the prompt. Shout-out to levelsio.

- **2026-03-25** | [Millie Marconi](https://x.com/milliemarconnni/status/2036363493478375797) | skills-mcp, prompting, agent-design
  A Claude Code skill that scans Reddit and X from the last 30 days on any topic and writes copy-paste-ready prompts from what the community has actually figured out. Type /last30days <topic> for top current patterns + a ready prompt; works for prompting, Midjourney, Suno, Cursor rules, etc. Open source, MIT.

- **2026-03-24** | [Factory](https://x.com/factoryai/status/2036184745059688923) | agent-design, industry, dev-practices
  Factory Missions now available to all users - long-running agents designed to automate large software tasks like building applications from scratch, migrations, and AI research.
